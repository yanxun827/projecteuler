    ...
    for y in range(height):
        for x in range(width):
            if x + CONSECUTIVE <= width:
                product = max(
                    calculate(x, y, 1, 0, CONSECUTIVE, grid), product)
            if y + CONSECUTIVE <= height:
                product = max(
                    calculate(x, y, 0, 1, CONSECUTIVE, grid), product)
            if x + CONSECUTIVE <= width and y + CONSECUTIVE <= height:
                product = max(
                    calculate(x, y, 1, 1, CONSECUTIVE, grid), product)
...
def calculate(x, y, dx, dy, n, grid):
    result = 1
    for i in range(n):
